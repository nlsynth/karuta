...
void Base::InitializeArray(IntArray *array,
...
void Base::AddThreadEntry(const string &name, int num, bool is_soft) {
  Object *obj = VAL(oreg()).object_;
  for (int i = 0; i < num; ++i) {
    Object *thread_obj =
...
Object *Base::CreateMemoryObject(const iroha::NumericWidth &width,
				     fe::ArrayShape *shape,
				     fe::ArrayInitializer *array_initializer,
				     Annotation *an) {
  vector<uint64_t> s;
...
Object *Base::CreateObjectArray(fe::ArrayShape *shape) {
