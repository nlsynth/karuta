...
class ExprCompiler {
 ...
 private:
  ...
  vm::Register *CompileAssignToArray(vm::Insn *insn, fe::Expr *lhs,
                                     vm::Register *rhs_reg);
  fe::Expr *ResolveArray(fe::Expr *access_expr,
  ...
  void PropagateRegisterType(vm::Insn *insn, vm::Register *lhs,
                             vm::Register *rhs, vm::RegisterType *t);
  RegisterTuple EmitFuncallDone(vm::Insn *call_insn, vm::Method *method,
                                int num_lhs);
