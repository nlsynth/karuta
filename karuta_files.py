...
LIB_FILES = ["lib/karuta.in", "lib/default-isynth.karuta", "lib/karuta_wait.v", "lib/karuta_exit.v", "lib/karuta_server.py", "lib/karuta_wrapper.py", "lib/karuta_examples.py","lib/fp/fp16raddsub.v",  "lib/fp/fp16rmul.v", "lib/fp/fp16r.karuta"]
